...
import {Component, html, stylesheet} from "./component.js";
...
export class MdMenu extends Component {
  ...
  render() {
    ...
    let h = html`
      <md-icon-button id="open" icon="${icon}"></md-icon-button>
      ${content}`;
    return h;
  }
...
export class MdLink extends Component {
  visible() { return this.state && (this.state.url || this.state.text); }
