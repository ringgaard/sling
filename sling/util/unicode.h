...
enum Normalization {
  ...
  NORMALIZE_NAMEPUNCT   = 0x20,  // remove name punctuation (period and dash)

  // Default normalization.
  NORMALIZE_DEFAULT = NORMALIZE_CASE | NORMALIZE_LETTERS | NORMALIZE_NAMEPUNCT
};
