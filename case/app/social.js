...
let xrefs = [
  ...
  {
    pattern: /^https?:\/\/(?:(?:www|m)\.)facebook\.com\/p\/([^\?\/]+)/,
    property: frame("P2013"),
  },
  {
  ...
  {
    pattern: /^https?:\/\/www\.facebook\.com\/p\/([A-Za-z0-9_\.\-]+)\/?/,
    property: frame("P2013"),
  },
  {
  ...
  {
    pattern: /^https:\/\/www\.familysearch\.org\/en\/tree\/person\/about\/(.+)/,
    property: frame("P2889"),
  },
  {
  ...
  {
    pattern: /^https:\/\/www\.myheritage\.dk\/research\/collection-1\/myheritage-family-slaegtstraeer\?itemId=([A-Z0-9-]+)/,
    property: frame("PMHI"),
  },
  {
